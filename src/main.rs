...
const GITHUB_REDIRECT_URI: &str = "https://wmdg5-jaaaa-aaaal-aav4q-cai.ic0.app";
...
const DISCORD_REDIRECT_URI: &str = "https://wmdg5-jaaaa-aaaal-aav4q-cai.ic0.app";
const DISCORD_CLIENT_ID: &str = "******";
const DISCORD_CLIENT_SECRET: &str = "******";
...
const TWITTER_REDIRECT_URI: &str = "https://wmdg5-jaaaa-aaaal-aav4q-cai.ic0.app";
const TWITTER_CLIENT_ID: &str = "******";
const TWITTER_BEARER_TOKEN: &str = "******";
